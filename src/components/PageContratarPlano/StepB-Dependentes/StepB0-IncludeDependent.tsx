...
export function StepB0IncludeDependent({ onIncludeNow, onIncludeLater }: StepB0IncludeDependentProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
      <div className="w-[1062px] h-[662px] flex items-start justify-center gap-[32px] rounded-2xl p-[24px] bg-BGStepB0 bg-cover relative">
        <button
        ...
        <div className="w-[50%] h-full bg-BGCardStepB0 bg-cover px-[48px] py-[40px] flex flex-col justify-between">
          <div className="w-full h-max flex flex-col gap-[32px]">
            ...
            <p className="max-w-[280px] TypographyPinter16g950">
              Garanta agora os benefícios Dental Uni aos seus entes
              queridos!
            </p>
          </div>
