...
// Importa os itens de menu do arquivo de configuração compartilhado
...
export function MobileMenu({
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50" onClick={() => setIsSidebarOpen(false)}>
      ...
      */}
      <div className="fixed inset-y-0 right-0 w-full max-w-[20.5rem] bg-white overflow-y-auto p-[16px] " onClick={(e) => e.stopPropagation()}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-end ">
            ...
            >
              <Icon name="IconCloseMenuMobile" className="w-6 h-6" /> {/* Ajustado tamanho do ícone */}
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto flex flex-col gap-4 justify-between pt-[116px]">
            ...
            <div className="mt-4"> {/* Adiciona um pouco de espaço acima do botão */}
              <Button
